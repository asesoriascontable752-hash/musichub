...
export default function VoiceRecorder({ onSaved }: VoiceRecorderProps) {
  ...
  async function save() {
    ...
    try {
      // 1. Obtener o crear etiqueta "Grabaciones"
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col items-center gap-3 py-4">
        ...
        <p className={`text-sm ${recState === 'recording' ? 'text-red-400 animate-pulse' : 'text-spotify-light-gray'}`}>
      ...
      {(recState === 'stopped' || recState === 'saving') && audioUrl && (
        <div className="space-y-4 border-t border-white/10 pt-4">
          ...
          <p className="text-xs text-white/40 flex items-center gap-1.5">
            ...
            Se guardará en la carpeta <strong className="text-white/70">Grabaciones</strong> (se crea sola si no existe)
          </p>
